...
export function CartDrawer({ open, onClose, primaryColor }: Props) {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-white rounded-t-2xl max-h-[85vh] flex flex-col max-w-lg mx-auto">
        {/* Handle */}
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 flex-shrink-0">
          <h2 className="font-semibold text-gray-900">Your Cart ({itemCount})</h2>
              ...
              <div key={item.itemId} className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                  <button
                    ...
                    className="w-7 h-7 rounded-full border border-gray-300 flex items-center justify-center text-gray-600 hover:bg-gray-50 text-sm font-bold"
                  >
                    −
                  </button>
                  ...
                  <button
                    ...
                    className="ml-1 w-7 h-7 rounded-full flex items-center justify-center text-red-400 hover:bg-red-50 text-xs"
                  >
                    🗑
                  </button>
                </div>
          ...
          {items.length > 0 && (
            <div className="pt-2 border-t border-gray-100">
              ...
              <textarea
                ...
                className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 resize-none"
              />
            </div>
          )}
        </div>
        ...
        {items.length > 0 && (
          <div className="px-4 py-4 border-t border-gray-100 flex-shrink-0 space-y-3">
            ...
            <button
              ...
              className="w-full py-3 rounded-xl font-semibold text-sm text-white bg-green-600 hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              📱 Order on WhatsApp
            </button>
